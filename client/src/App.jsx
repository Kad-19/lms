...
import ChildCoursesList from "./Pages/course/ChildCoursesList";
  ...
  useEffect(() => {
    const setTitle = () => {
      ...
      if (path === "/") {
        ...
        document.title = "Chatbot - Learning Management System";
      }
    };
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/child-courses/:child_email"
          element={<ChildCoursesList />}
        />
        ...
        <Route element={<RequiredAuth allowedRole={["PARENT"]} />}>
          <Route path="/parent-dashboard" element={<ParentDashboard />} />
        </Route>
        <Route
          element={<RequiredAuth allowedRole={["ADMIN", "USER", "PARENT"]} />}
        >
