    ...
    <HomeLayout>
      ...
      <div className="flex flex-col gap-3 justify-center items-center h-[91vh]">
        <form
          ...
          className="lg:w-[450px] w-[90%] md:w-1/2 h-fit p-7 flex flex-col gap-5 justify-between rounded-md bg-white text-black shadow-md"
        >
          <div>
          ...
          <select
            ...
            className="select select-primary text-slate-400"
            name='role'
            id='role'
            onChange={handleUserInput}
          >
            <option disabled={true}>Pick signup option</option>
          ...
          <div className="flex items-center w-full gap-4 ">
            {viewImage ? (
              <img
                src={viewImage}
                alt="photo"
                className="rounded-[50%] w-14 h-14 hidden lg:block"
              />
            ) : (
              <label
                htmlFor="image"
                className="text-xl hidden lg:block md:block"
              >
                <BsCloudUpload />
              </label>
            )}
          ...
          <div className="flex items-center w-full gap-4 border-2 border-yellow-500 px-4 rounded-lg h-14 bg-slate-900">
            <label
              htmlFor="name"
              className="text-xl hidden lg:block md:block text-yellow-500"
            >
              <BsPerson />
            </label>
            <input
